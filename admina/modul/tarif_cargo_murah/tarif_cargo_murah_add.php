                ...
                <section class="content-header">
                    <h1>
                     TARIF CARGO MURAH
                        ...
                        <li class="active">Tambah TARIF CARGO MURAH</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                                 <div class="box-header">
                                    <h3 class="box-title">Tambah TARIF CARGO MURAH</h3>
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/tarif_cargo_murah/tarif_cargo_murah_action.php?act=in">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="kota_tujuan" placeholder="kota_tujuan" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="harga_balik" placeholder="harga_balik" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
