...
<div class="row">
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/provinsi/provinsi_action.php?act=in">
                      <div class="form-group">
                        <label for="nama_provinsi" class="control-label col-lg-2">nama_provinsi</label>
                        <div class="col-lg-10">
                          <input type="text" name="nama_provinsi" placeholder="nama_provinsi" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
