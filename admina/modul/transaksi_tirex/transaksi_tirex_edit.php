                 ...
                 <table class="table transaksitirex">
                            ...
                            <legend class="text-center">Detail Pengirim</legend>
                              <table class="table">
                                 <tr>
                                    <td>Nama Pengirim</td>
                                    <td>
                                      <select class="form-control chzn-select" id="customer" value="<?=$data_edit->customer;?>">
                                  ...
                                  <tr>
                                     <td>Dari</td>
                                    <td>
                                      <select name="dari" data-placeholder="Pilih dari..." class="form-control chzn-select" tabindex="2" >
                                       <option value=""></option>
                                  ...
                                  <tr>
                                    <td>Tujuan</td>
                                    <td>
                                      <select name="tujuan" data-placeholder="Pilih tujuan..." class="form-control chzn-select" tabindex="2" >
                                       <option value=""></option>
                                       <?php foreach ($db->fetch_all("tarif_tirex") as $isi) {

                                          if ($data_edit->tujuan==$isi->kode_kota) {
                                            echo "<option value='$isi->kode_kota' selected>$isi->kota</option>";
                                          } else {
                                          echo "<option value='$isi->kode_kota'>$isi->kota</option>";
                                            }
                                       } ?>
                                      </select>
                                    </td>  
                                  ...
                                  <tr>
                                    <td>Harga</td>
                                    <td>
                                      <input type="text" class="form-control" name="harga" id="harga" value="<?=$data_edit->harga;?>">
                                    </td>
                        ...
                        <fieldset>
                            <legend class="text-center">Detail Penerima</legend>
                                <table class="table">
                                    <tr>
                                      <td>Nama Penerima</td>
                                      <td><input type="text" id="penerima" class="form-control" value="<?=$data_edit->nama_penerima;?>"></td>
                                      
                                    </tr>
                                    <tr>
                                      <td>Email</td>
                                      <td>
                                        <input type="text" id="email_penerima" class="form-control" value="<?=$data_edit->email_penerima;?>">
                                        <small>Untuk Notifikasi Tracking Kiriman</small>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Telepon</td>
                                      <td><input type="text" id="telepon" class="form-control" value="<?=$data_edit->no_hp_penerima;?>"></td>
                                    </tr>
                                    <tr>
                                    
                                    <tr>
                                      <td>Catatan</td>
                                      <td><input type="text" id="catatan" class="form-control" value="<?=$data_edit->catatan;?>"></td>
                                    </tr>
                                  </table>
                  ...
                  <table class="table">
                    <tr>
                      ...
                      <td colspan="3"><input type="text" id="alamat_pengambilan" class="form-control" value="<?=$data_edit->alamat_pengambilan;?>"></td>
                    </tr>
                      <td width="200">Alamat Tujuan</td>
                        <td>
                          <input type="text" id="alamat_tujuan" class="form-control" value="<?=$data_edit->alamat_tujuan;?>">
                        </td>
                      </tr>
                  </table>
