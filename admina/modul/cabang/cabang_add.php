...
<div class="row">
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/cabang/cabang_action.php?act=in">
                      <div class="form-group">
                        <label for="nama_cabang" class="control-label col-lg-2">nama_cabang</label>
                        <div class="col-lg-10">
                          <input type="text" name="nama_cabang" placeholder="nama_cabang" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="kode_cabang" class="control-label col-lg-2">kode_cabang</label>
                        <div class="col-lg-10">
                          <input type="text" name="kode_cabang" placeholder="kode_cabang" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
